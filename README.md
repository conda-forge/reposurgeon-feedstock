...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/reposurgeon-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/reposurgeon-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add reposurgeon
# for installing globally
pixi global install reposurgeon
```
...
It is possible to list all of the versions of `reposurgeon` available on your platform:
...
```
pixi search reposurgeon --channel conda-forge
```
